            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full bg-black/50 border border-white/5 rounded-sm px-3 py-1.5 text-[10px] text-gray-200 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/20 font-mono transition-all h-8"
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full bg-black/50 border border-white/5 rounded-sm px-3 py-1.5 text-[10px] text-gray-200 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/20 transition-all font-mono h-8"
