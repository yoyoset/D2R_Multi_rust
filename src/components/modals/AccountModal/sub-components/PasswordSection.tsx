    ...
    return (
        <div className="space-y-3">
            <div className="flex items-center gap-4">
                ...
                <div className="relative flex-1 group/pass">
                    <input
                        ...
                        className={cn(
                            "w-full bg-black/50 border border-white/5 rounded-sm pl-3 pr-10 py-1.5 text-[11px] text-gray-200 focus:outline-none focus:ring-1 transition-all font-mono h-8",
            ...
            {!passwordError && winPass === "********" && (
                <div className="flex items-center gap-1.5 px-[3.5rem] text-[9px] text-zinc-500 animate-in fade-in slide-in-from-top-1">
