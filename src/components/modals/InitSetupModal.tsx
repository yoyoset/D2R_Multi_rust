                    ...
                    {!isRestartMode ? (
                        <>
                            <div className="space-y-2 text-center">
                                <p className="text-[11px] text-text-dim leading-relaxed uppercase tracking-wider">
                                    {t('init_setup_desc')}
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-black uppercase tracking-widest text-text">{t('init_setup_create')}</span>
                                ...
                                <button
                                    ...
                                    disabled={isProcessing}
                                    className="group flex items-center gap-4 p-4 rounded-sm bg-surface/50 border border-line hover:border-player/40 hover:bg-player-500/5 transition-all text-left"
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-black uppercase tracking-widest text-text">{t('init_setup_load')}</span>
