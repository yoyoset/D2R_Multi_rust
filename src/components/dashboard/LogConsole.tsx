...
export const LogConsole: React.FC<LogConsoleProps> = ({ logs, onClear }) => {
    ...
    return (
        <div className="flex-shrink-0 w-full max-w-5xl mt-2 animate-in slide-in-from-bottom-4 duration-500">
            <div className="bg-zinc-950/40 border border-white/5 rounded-sm overflow-hidden backdrop-blur-sm shadow-2xl transition-all duration-300">
                <div
                ...
                <div className={cn(
                    ...
                    {logs.length === 0 ? (
                        <div className="text-zinc-600 italic py-2 opacity-50">
