...
export function NotificationManager() {
    ...
    return (
        <Modal isOpen={isOpen} onClose={close}>
            <ModalContent className="max-w-md border-line bg-bg/95 backdrop-blur-xl">
                ...
                <ModalBody>
                    <div className="space-y-4">
                        <div className="text-text-dim leading-relaxed whitespace-pre-wrap text-[10px] font-mono uppercase italic">
                        ...
                        {confirmText && (
                            <div className="mt-4 p-4 border border-danger-500/10 bg-danger-500/5 rounded-sm space-y-2 animate-in slide-in-from-bottom-2 duration-300">
                                ...
                                <input
                                    ...
                                    className="w-full bg-black/60 border border-line-2 rounded-sm px-3 py-2 text-[14px] text-text placeholder:text-text-faint outline-none focus:border-danger-500/50 transition-all font-mono"
                                />
                            </div>
                        )}
                    </div>
