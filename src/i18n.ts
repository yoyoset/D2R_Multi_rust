...
const resources = {
    "zh-CN": {
        translation: {
            ...
            "kill_processes_clashpad": "终止所有相关进程 (Nuke)",
            ...
            "nuke_reset": "全系统一键复位 (Nuke)",
            "nuke_confirm_desc": "此操作将关闭所有正在运行的游戏和战网，并删除所有账号的自动登录记录。请输入 \"yes\" 确认执行：",
            "open_user_switch": "切换用户 (Lock)",
            "system_utils": "系统工具",
    ...
    "en": {
        translation: {
            ...
            "kill_processes_clashpad": "Kill All Related Processes (Nuke)",
            ...
            "nuke_reset": "Total System Reset (Nuke)",
            "nuke_confirm_title": "DANGER: Total System Reset",
            "nuke_confirm_desc": "This will close all running games and delete all saved login tokens for every account. Please type \"yes\" to confirm:",
            "open_user_switch": "Switch User (Lock)",
    ...
    "ja": {
        translation: {
            ...
            "nuke_confirm_desc": "実行するには \"yes\" を入力してください：",
            "open_user_switch": "ユーザー切り替え (Lock)",
    ...
    "ko": {
        translation: {
            ...
            "nuke_confirm_desc": "실행하려면 \"yes\"를 입력하세요：",
            "open_user_switch": "사용자 전환 (Lock)",
