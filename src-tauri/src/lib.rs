...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            modules::account::get_snapshot_game_paths,
            modules::account::verify_live_config,
            modules::account::resolve_baseline_conflict,
            modules::account::rescan_pending_conflicts,
            modules::account::ack_baseline_seed_report,
